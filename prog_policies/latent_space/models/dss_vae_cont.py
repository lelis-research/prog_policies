...
class DSSVAECont(BaseVAE):
    ...
    def get_losses_and_accs(self, data_batch: tuple, output: tuple,
        ...
        progs_loss, rec_a_h_loss, rec_struct_loss, disc_a_h_loss, disc_struct_loss, latent_loss = zero_tensor, zero_tensor, zero_tensor, zero_tensor, zero_tensor, zero_tensor
        ...
        return Losses(progs_loss, rec_a_h_loss, disc_a_h_loss, rec_struct_loss, disc_struct_loss, latent_loss),\
            Accuracies(progs_t_accuracy, progs_s_accuracy, a_h_t_accuracy, a_h_s_accuracy, struct_t_accuracy, struct_s_accuracy,
                       adv_a_h_t_accuracy, adv_a_h_s_accuracy, adv_struct_t_accuracy, adv_struct_s_accuracy)
